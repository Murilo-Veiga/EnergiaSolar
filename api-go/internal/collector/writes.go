...
func writeInverterStatus(ctx context.Context, db *pgxpool.Pool, plantID, inverter string, powerKW, dayKWh float64, temperatureC *float64) error {
	_, err := db.Exec(ctx,
		`INSERT INTO inverter_status (plant_id, inverter, recorded_at, power_kw, day_kwh, temperature_c)
		 VALUES ($1, $2, now(), $3, $4, $5)`,
		plantID, inverter, powerKW, dayKWh, temperatureC,
	)
	return err
}
